...
import copy
import torch
from .ResNet18ForCIFAR import resnet18
...
def SplitEffNet(width=1, weights=None, num_classes=1000, stop_layer=4,
    ...
    if architectura == 'mobilenetv2':
        ...
        mobilenetv2 = models.mobilenet_v2(weights=weights, num_classes=1000, width_mult=width,
